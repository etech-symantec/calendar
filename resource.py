...
def run(playwright):
    ...
    <head>
        ...
        <style>
            ...
            .timeline-event-bar.vehicle {{ background-color: #4b5563 !important; border: 1px solid #374151 !important; color: #ffffff !important; }}
            .timeline-event-bar.vehicle:hover {{ background-color: #1f2937 !important; }}
            
            /* 🌟 [추가됨] 시에스타/테라피 (점선 테두리) */
            .timeline-event-bar.rest {{ border-style: dashed !important; border-width: 2px !important; }}
